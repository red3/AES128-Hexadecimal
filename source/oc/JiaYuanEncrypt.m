...
+(NSString *)AES128Encrypt:(NSString *)plainText key:(NSString *)key
{
    ...
    if (cryptStatus == kCCSuccess) {
        ...
        resultData = [[[NSData alloc] initWithBytes:buffer length:numBytesEncrypted] autorelease];
    }
    free(buffer);
...
+(NSString *)AES128Decrypt:(NSString *)encryptText key:(NSString *)key
{
    ...
    if (cryptStatus == kCCSuccess) {
        ...
        resultData = [[[NSData alloc] initWithBytes:buffer length:numBytesCrypted] autorelease];
